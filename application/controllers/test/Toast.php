...
abstract class Toast extends MY_Controller {
	...
	function __construct($name) {
        ...
        $this->fixtures = new unit_test_fixtures($this);
    ...
    function _assert_true($assertion, $line=null) {
		if($assertion) {
			return TRUE;
        } else {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line;
			$this->asserts = FALSE;
			return FALSE;
		}
	}

	function _assert_false($assertion, $line=null) {
		if($assertion) {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line;
			$this->asserts = FALSE;
			return FALSE;
	...
	function _assert_true_strict($assertion, $line=null) {
		if($assertion === TRUE) {
			return TRUE;
		} else {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line;
	...
	function _assert_false_strict($assertion, $line=null) {
		if($assertion === FALSE) {
			return TRUE;
		} else {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line;
	...
	function _assert_equals($base, $check, $line=null) {
		if($base == $check) {
			return TRUE;
		} else {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line.": is $check, should be $base";
			$this->asserts = FALSE;
			return FALSE;
		}
	}

	function _assert_not_equals($base, $check, $line=null) {
		if($base != $check) {
			return TRUE;
		} else {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line.": is $check, should not be $base";
			$this->asserts = FALSE;
			return FALSE;
		}
	}
	...
	function _assert_empty($assertion, $line=null) {
		if(empty($assertion)) {
			return TRUE;
		} else {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line;
    ...
    function _assert_not_empty($assertion, $line=null) {
		if(!empty($assertion)) {
			return TRUE;
		} else {
            if (!is_null($line)) $this->message = 'Failed assertion at line '.$line;
    ...
    public function __call($method, $args) {
        return $this->fixtures->{$method}($args);
    }

    public function reset_table($table) {
        $this->fixtures->reset_table($table);
    }

    public function reset_tables($tables = array()) {
        $this->fixtures->reset_tables($tables);
    }
